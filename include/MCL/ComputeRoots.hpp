...
compute_min_pos_root_2D(const Eigen::MatrixXd& x, const Eigen::MatrixXi& E, Eigen::MatrixXd& p, int f)
{
    ...
    double b = U11 * V22 - U12 * V21 - U21 * V12 + U22 * V11 - U11 * V32 + U12 * V31 + U31 * V12 - U32 * V11 +
               U21 * V32 - U22 * V31 - U31 * V22 + U32 * V21;
