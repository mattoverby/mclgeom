...
void
Shader::init(const std::string& vertex_source, const std::string& frag_source)
{
    // Create the resource
...
void
Shader::init_from_files(const std::string& vertex_file, const std::string& frag_file)
{
    ...
    if (vert_in) {
        vert_string = (std::string((std::istreambuf_iterator<char>(vert_in)), std::istreambuf_iterator<char>()));
    } else {
    ...
    if (frag_in) {
        frag_string = (std::string((std::istreambuf_iterator<char>(frag_in)), std::istreambuf_iterator<char>()));
    } else {
...
void
Shader::init_from_strings(const std::string& vertex_source, const std::string& frag_source)
{
