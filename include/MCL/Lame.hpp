...
public:
	...
	static Lame one(int model_=0) { Lame l; l.set_lame(0,1); l.set_model(model_); return l; } // bulkmod = 1
	...
	Lame (double k, double v, int model_=0) :
		m_limit_min(-100.0),
		m_limit_max(100.0)
		{ set_yp(k,v); set_model(model_); }

	// Default = soft rubber
	Lame() : Lame(10000000,0.399) {}
